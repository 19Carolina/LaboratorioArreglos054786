 ...
 */
package laboratorioarreglos054786;

/**
 *
 * @author carol
 */
public class LaboratorioArreglos054786 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(arreglo[3 - 1]);
        System.out.println(arreglo[4 - 1]);
        System.out.println(arreglo[5 - 1]);
        
        //Segunda parte: Inicialización automatica
        int[] calificaciones = { 10, 8, 6, 9, 9, 7};
        System.out.println("Los " + calificaciones.length +
                " elementos califiones: ");
